...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 margin-top-20">
                    ...
                    <a href="#" class="btn-red scrool">Discover More</a>
                ...
                <div class="col-md-6">
                    ...
                    <iframe width="560" height="365" class="frame-border wow bounceIn" src="https/wwwyoutubecom/embed/ZaqZcDOoi-8_219368505.html" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="main-services blue">
                            ...
                            <img src="images/services2.jpg" class="width-100">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="main-services red">
                            ...
                            <img src="images/services3.jpg" class="width-100">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="main-services yellow">
                            ...
                            <img src="images/services1.jpg" class="width-100">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 padding-bottom-30 wow slideInLeft" data-wow-delay="0.25s" style="visibility: visible; animation-delay: 0.25s; animation-name: slideInLeft;">
                    ...
                    <img src="images/about01.png" class="width-100 bottom-margins-images" alt="pic">
                ...
                <div class="col-md-6 padding-bottom-30">
                    ...
                    <div class="tab-content margin-left-20" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <img src="images/about04.png" class="width-100 top-margins-images" alt="pic">
                        </div>

                        <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                            <img src="images/about05.png" class="width-100 top-margins-images" alt="pic">
                        </div>

                        <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                            <img src="images/about06.png" class="width-100 top-margins-images" alt="pic">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 text-center margin-top-30">
                    ...
                    <img src="images/team1.png" class="team-img lyla width-100" alt="pic">
                ...
                <div class="col-sm-12 col-md-4 text-center margin-top-30">
                    ...
                    <img src="images/team2.png" class="team-img blue width-100" alt="pic">
                ...
                <div class="col-sm-12 col-md-4 text-center margin-top-30">
                    ...
                    <img src="images/team3.png" class="team-img yellow width-100" alt="pic">
                            ...
                            <div class="card-header" id="headingOne">
                                <h5 class="mb-0">
                                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        <img src="images/team1.png" alt="testimonials" class="testim-img">
                            ...
                            <div class="card-header" id="headingTwo">
                                <h5 class="mb-0">
                                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        <img src="images/team2.png" alt="testimonials" class="testim-img">
                            ...
                            <div class="card-header" id="headingThree">
                                <h5 class="mb-0">
                                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        <img src="images/team3.png" alt="testimonials" class="testim-img">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 p-0 m-0">
                    ...
                    <figure class="gallery-insta">
                        <!--begin popup-gallery-->
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="images/gallery2.jpg">
                                <img src="images/gallery2.jpg" class="width-100" alt="pic">
                                <span class="eye-wrapper"><i class="fa fa-search-plus eye-icon" style="font-size: 38px;"></i></span>
                            </a>
                        </div>
                        <!--end popup-gallery-->
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 p-0 m-0">
                    ...
                    <figure class="gallery-insta">
                        <!--begin popup-gallery-->
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="images/gallery3.jpg">
                                <img src="images/gallery3.jpg" class="width-100" alt="pic">
                                <span class="eye-wrapper"><i class="fa fa-search-plus eye-icon" style="font-size: 38px;"></i></span>
                            </a>
                        </div>
                        <!--end popup-gallery-->
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 p-0 m-0">
                    ...
                    <figure class="gallery-insta">
                        <!--begin popup-gallery-->
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="images/gallery4.jpg">
                                <img src="images/gallery4.jpg" class="width-100" alt="pic">
                                <span class="eye-wrapper"><i class="fa fa-search-plus eye-icon" style="font-size: 38px;"></i></span>
                            </a>
                        </div>
                        <!--end popup-gallery-->
                    ...
                    <figure class="gallery-insta">
                        <!--begin popup-gallery-->
                        <div class="popup-gallery popup-gallery-rounded portfolio-pic">
                            <a class="popup2" href="images/gallery5.jpg">
                                <img src="images/gallery5.jpg" class="width-100" alt="pic">
                                <span class="eye-wrapper"><i class="fa fa-search-plus eye-icon" style="font-size: 38px;"></i></span>
                            </a>
                        </div>
                        <!--end popup-gallery-->
    ...
    <div class="newsletter_wrapper">
        ...
        <div class="newsletter-section-overlay"></div>
            ...
            <div class="newsletter_box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <img src="images/email.png" alt="picture" class="padding-top-15">
                    ...
                    <div class="blog-item">
                        ...
                        <div class="popup-wrapper">
                            <div class="popup-gallery">
                                <a href="#">
                                    <img src="images/about1.jpg" class="width-100" alt="pic">
                ...
                <div class="col-md-4">
                    ...
                    <div class="blog-item">
                        ...
                        <div class="popup-wrapper">
                            <div class="popup-gallery">
                                <a href="#">
                                    <img src="images/about2.jpg" class="width-100" alt="pic">
                                    <span class="eye-wrapper2"><i class="fa fa-link eye-icon"></i></span>
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="blog-item">
                        ...
                        <div class="popup-wrapper">
                            <div class="popup-gallery">
                                <a href="#">
                                    <img src="images/about3.jpg" class="width-100" alt="pic">
                                    <span class="eye-wrapper2"><i class="fa fa-link eye-icon"></i></span>
                                </a>
                            </div>
                        </div>
